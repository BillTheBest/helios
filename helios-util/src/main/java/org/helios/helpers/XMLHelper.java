...
public class XMLHelper {
	 ...
	 */
	public static String getAttributeValueByName(Node node, String name, String defaultValue) {
	 ...
	 */
	public static boolean getAttributeBooleanByName(Node node, String name, boolean defaultValue) {
	...
	public static void main(String[] args) {
		...
		/*
		try {
			String attrValue = getAttribute(
					"C:/projects3.3/HeliosUtils/findbugs-out/fb.xml",
					"BugCollection/Project",
					"filename"					
			);
			log("Attribute Value:" + attrValue);
			updateAttributeInXMLFile(
					"C:/projects3.3/HeliosUtils/findbugs-out/fb.xml",
					"BugCollection/Project",
					"filename",
					"MyCoolProject"

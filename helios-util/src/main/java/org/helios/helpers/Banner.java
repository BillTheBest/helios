...
/**
 * <p>Title: Banner</p>
 * <p>Description: Console banner printing utility class</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * @version $LastChangedRevision$
 * <p><code>org.helios.helpers.Banner</code></p>
 */
...
public class Banner {
	...
	public static void main(String[] args) {
		bannerOut("#", 3, 10, "Yo mama's", "a pajama", "and she", "ain't no good");
		bannerOut("Yo mama's", "a pajama", "and she", "ain't no good");
	}

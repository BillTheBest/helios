 ...
 * <p>Description: Static String helper utilities.</p> 
 * <p>Company: Helios Development Group</p>
 * @author Whitehead (whitehead.nicholas@gmail.com)
 * @version $LastChangedRevision: 1742 $
 * $HeadURL: https://helios.dev.java.net/svn/helios/helios-utils/branches/DEV-0.1/src/org/helios/helpers/StringHelper.java $
 * $Id: StringHelper.java 1742 2010-01-16 19:48:41Z nwhitehead $
 */
...
//			log("\t[" + m.group(2) + "]");
	...
	public static StringBuilder trimCharacters(final StringBuilder buff, String trimChar) {
	   ...
	   public static void main(String[] args) {
		   ...
		   log("[" + trimCharacters(b, ",,") + "]");
		   
		   
//		   System.setProperty("home.planet", "Earth");
//		   System.setProperty("remote.planet", "Venus");
//		   String value = "Hello ${home.planet:Neptune}. This is ${remote.planetx:Jupiter}. What is you status ?";
//		   log(tokenReplaceSysProps("$", "{", "}", ":", value));
		   
		 //===============================================================
//			log("StringHelper");
//			log(parseWhiteSpaceQuoted("-a \"Hello World\" foo bar"));
		   //===============================================================
//			if(args.length < 1) return;
//			if(args[0].equalsIgnoreCase("replaceStringInFile")) {
//				if(args.length != 4) {
//					System.err.println("Invalid Argument Count. Usage: replaceStringInFile <fileName> <targetString> <replacementString>");
//				}
//				replaceStringInFile(args[1], args[2], args[3]);
//			}    	
	    }	

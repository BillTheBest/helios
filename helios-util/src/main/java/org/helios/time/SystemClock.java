 ...
 * <p><code>org.helios.time.SystemClock</code></p>
 */
...
public enum SystemClock {
	...
	public static class ElapsedTime {
		...
		public static final Map<TimeUnit, String> UNITS = Collections.unmodifiableMap(CollectionHelper.createKeyedValueMap(TimeUnit.class, String.class, 
				TimeUnit.DAYS, "days",
				TimeUnit.HOURS, "hrs.",

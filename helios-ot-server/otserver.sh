...
export CMD_LINE="-el ./src/test/resources/server/conf/OTServer.launch -conf ./src/test/resources/server/conf -log4j ./src/test/resources/server/conf/log4j/log4j.xml -daemon "

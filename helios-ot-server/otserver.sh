...
export CMD_LINE="-el ./src/test/resources/server/conf/DevOTServer.launch -conf ./src/test/resources/server/conf -log4j ./src/test/resources/server/conf/log4j/log4j.xml -daemon "
...
export SYS_PROPS=" -Djava.rmi.server.hostname=helioshq"
export JAVA_OPTS=""

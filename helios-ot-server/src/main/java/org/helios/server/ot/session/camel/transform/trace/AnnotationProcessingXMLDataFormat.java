...
/**
 * <p>Title: AnnotationProcessingXMLDataFormat</p>
 * <p>Description: </p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * @version $LastChangedRevision$
 * <p><code>org.helios.server.ot.session.camel.transform.trace.AnnotationProcessingXMLDataFormat</code></p>
 */

public class AnnotationProcessingXMLDataFormat extends XStreamDataFormat {
	protected final Class<?>[] annotatedClasses;
	protected final Logger log = Logger.getLogger(getClass());

	/**
	 * Creates a new AnnotationProcessingXMLDataFormat
	 */
	public AnnotationProcessingXMLDataFormat() {
    ...
    /**
     * {@inheritDoc}
     * <p>Creates an XML XStream serializer, customized for OpenTrace</p>
     * @see org.apache.camel.dataformat.xstream.AbstractXStreamWrapper#createXStream(org.apache.camel.spi.ClassResolver)
     */
    @Override

...
/**
 * <p>Title: StringBinder</p>
 * <p>Description:Binds values as strings and replaces as strings </p> 
...
public class StringBinder implements IBinder {
	...
	public int bind(PreparedStatement ps, int bindSequence, Object bindValue) 	throws SQLException {
		ps.setString(bindSequence, bindValue.toString());
		return bindSequence;
	}

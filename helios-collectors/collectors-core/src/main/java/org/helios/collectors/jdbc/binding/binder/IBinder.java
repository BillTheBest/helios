 ...
 *
 */
package org.helios.collectors.jdbc.binding.binder;

import java.sql.PreparedStatement;
import java.sql.SQLException;

import org.helios.collectors.jdbc.binding.provider.BindProviderConfigurationException;

/**
 * <p>Title: IBinder</p>
 * <p>Description: Defines a class that performs a prepared statement bind or statement bind token replace for targetted data types.</p> 

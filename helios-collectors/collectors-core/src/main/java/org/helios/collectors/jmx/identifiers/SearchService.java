 ...
 *
 */
package org.helios.collectors.jmx.identifiers;
...
import org.helios.collectors.jmx.IMBeanServerConnectionFactory;
import org.helios.helpers.JMXHelper;
import org.helios.helpers.RegexHelper;
...
public class SearchService extends ManagedObjectDynamicMBean {
	/** Instance logger */
	 ...
	 */
	@JMXOperation(name="getHosts", description="Returns an array of hosts that match the passed pattern") 
	 ...
	 */
	@JMXOperation(name="getVMs", description="Returns an array of vms that match the passed pattern") 
	 ...
	 */
	@JMXOperation(name="getDefaultDomains", description="Returns an array of MBeanServer default domains that match the passed pattern") 
	 ...
	 * @return
	 */
	@JMXOperation(name="getSpec", description="Parameterized lookup")
...
//	 * @return
//	 */
//	@JMXOperation(name="getMap", description="Parameterized lookup")
//	public String[] getMap(String...args) {
//		Map<String, String> modifiers = new HashMap<String, String>(args!=null ? args.length : 0);
//		for(String s: args) {
//			String[] frags = s.trim().split("=");
//			modifiers.put(frags[0], frags[1]);
//		}		
//		String type = modifiers.get("type");
//		String pattern = modifiers.get("pattern");
//		return getSpec(type, pattern, modifiers);
//	}	
	 ...
	 */
	@JMXOperation(name="getSubDomains", description="Returns an array of MBeanServer subdomains that match the passed pattern") 

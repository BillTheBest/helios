 ...
 *
 */
package org.helios.collectors.timeout;
...
public class ThreadWatcher extends ManagedObjectDynamicMBean implements ThreadFactory, ThreadWatchListener {
	...
	protected ThreadWatcher() {
		String tmp = org.helios.helpers.ConfigurationHelper.getEnvThenSystemProperty(TP_POOL_SIZE_PROP, "" + DEFAULT_TP_POOL_SIZE);
		...
		try {
			JMXHelperExtended.getHeliosMBeanServer().registerMBean(this, OBJECT_NAME);
		} catch (Exception e) {
	 ...
	 */
	@JMXAttribute(name="ThreadWatches", description="A summary of active thread watches", mutability=AttributeMutabilityOption.READ_ONLY)
	 ...
	 * @return the poolSize
	 */
	@JMXAttribute(name="PoolSize", description="The number of threads in the watcher's thread pool", mutability=AttributeMutabilityOption.READ_ONLY)
	 ...
	 * @return
	 */
	@JMXAttribute(name="CurrentWatches", description="The current number of active thread watches", mutability=AttributeMutabilityOption.READ_ONLY)
	 ...
	 * @return
	 */
	@JMXAttribute(name="TotalTasks", description="The total number of scheduled tasks completed", mutability=AttributeMutabilityOption.READ_ONLY)
	 ...
	 * @return the stops
	 */
	@JMXAttribute(name="Stops", description="The total number of successful stops.", mutability=AttributeMutabilityOption.READ_ONLY)
	 ...
	 * @return the overruns
	 */
	@JMXAttribute(name="Overruns", description="The total number of overruns.", mutability=AttributeMutabilityOption.READ_ONLY)
	 ...
	 * @return the watches
	 */
	@JMXAttribute(name="Watches", description="The total number of requested watches.", mutability=AttributeMutabilityOption.READ_ONLY)
	 ...
	 * @return
	 */
	@JMXAttribute(name="AverageOverrunProcessingTime", description="The average elapsed time for overrun processing.", mutability=AttributeMutabilityOption.READ_ONLY)

 ...
 * <p>Description: Exception thrown from JDBCConnectionFactories when they fail to return a connection.</p> 
...
public class JDBCConnectionFactoryException extends Exception {
	...
	/**	 */
	private static final long serialVersionUID = -5796633579289328141L;

...
/**
 * <p>Title: OSException</p>
 * <p>Description: An exception that should be thrown by the pluggable OS implementation 
 * when an error occurs that cannot be handled properly by that implementation.</p> 

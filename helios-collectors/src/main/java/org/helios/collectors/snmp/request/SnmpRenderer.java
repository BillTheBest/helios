 ...
 * $Id$
 */
public class SnmpRenderer extends AbstractSnmpRenderer {

	public	SnmpRenderer(Integer inHeliosType) {
		super();
		this.metricType=MetricType.typeForCode(inHeliosType);
	}
	/* (non-Javadoc)

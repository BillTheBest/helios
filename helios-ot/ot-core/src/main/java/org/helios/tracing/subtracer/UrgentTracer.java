...
public class UrgentTracer extends DelegatingTracer implements IUrgentTracer {

	/**
	 * Creates a new UrgentTracer
	 * @param vtracer The inner tracer
	 */
	public UrgentTracer(ITracer vtracer) {
		super(vtracer, "UrgentTracer->" + vtracer.getTracerName());
	}

...
public class SubTracerKey {
	...
	public SubTracerKey(Class<? extends ISubTracer> subTracerType, String...subKeys) {
	...
	public static SubTracerKey makeKey(Class<? extends ISubTracer> subTracerType, String...subKeys) {
		return new SubTracerKey(subTracerType, subKeys);
	}
	
	private static String[] makeArr(Class<? extends ISubTracer> subTracerType, String...subKeys) {

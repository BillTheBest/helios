...
/**
 * <p>Title: EndpointConnectException</p>
 * <p>Description: Exception thrown by Endpoint concrete classes 
 *   indicating connection or data related error(s) during interaction 
 *   with target endpoint.</p> 
 * <p>Company: Helios Development Group</p>
 * @author Sandeep Malhotra (smalhotra@heliosdev.org)
 */
public class EndpointConnectException extends Exception {

	private static final long serialVersionUID = 1244590041139246767L;

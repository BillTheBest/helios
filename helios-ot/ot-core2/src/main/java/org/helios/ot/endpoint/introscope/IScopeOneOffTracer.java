...
/**
 * <p>Title: IScopeOneOffTracer</p>
 * <p>Description: A base class for implementing one off reflective invokers for the wily agent.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>test.org.helios.ot.trace.IScopeOneOffTracer</code></p>
 */

public class IScopeOneOffTracer {
	/** Singleton instance */
	protected static volatile IScopeOneOffTracer instance = null;
	 ...
	 */
	public static IScopeOneOffTracer getInstance() {
		if(instance==null) {
			synchronized(lock) {
				if(instance==null) {
					instance = new IScopeOneOffTracer(); 
				}
			}
		}
		return instance;
	...
	/**
	 * Creates a new IScopeOneOffTracer
	 */
	private IScopeOneOffTracer() {
...
//						log("/** The metric type name constant for " + type + "s */");
//						log("public static final String " + type.toUpperCase() + "_TYPE = \"" + type + "\";");
	...
	public static void main(String[] args) {
		...
		try {
			...
			IScopeOneOffTracer iscope = IScopeOneOffTracer.getInstance();

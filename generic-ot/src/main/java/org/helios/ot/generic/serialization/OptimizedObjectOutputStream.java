 ...
 * <p><code>org.helios.ot.generic.serialization.OptimizedObjectOutputStream</code></p>
 */
...
public class OptimizedObjectOutputStream extends ObjectOutputStream {
	...
	public static final byte OPTIMIZED_DESCRIPTOR = 1;
	/** The leading value in the stream indicating that the following class descriptor is standard */
	public static final byte STANDARD_DESCRIPTOR = 0;

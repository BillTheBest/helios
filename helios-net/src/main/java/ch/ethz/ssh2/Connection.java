...
public class Connection
{
	 ...
	 */
	public final static String identification = "Ganymed Build_250";
	 ...
	 * @throws IOException
	 */
	public synchronized LocalPortForwarder createLocalPortForwarder(int local_port, String host_to_connect, int port_to_connect, LocalAcceptThreadStateListener streamListener ) throws IOException
	{
		if (tm == null)
	...
	public synchronized LocalPortForwarder createLocalPortForwarder(InetSocketAddress addr, String host_to_connect,
			int port_to_connect, LocalAcceptThreadStateListener streamListener ) throws IOException
	{
		if (tm == null)
			throw new IllegalStateException("Cannot forward ports, you need to establish a connection first.");
	...
	/**
	 * Retrieves the total number of bytes transferred from remotes to locals through this connection.
	 * @return the total number of bytes transferred from remotes to locals 
	 */
	...
	/**
	 * Retrieves the total number of bytes transferred from locals to remotes through this connection.
	 * @return the total number of bytes transferred from locals to remotes 
	 */	

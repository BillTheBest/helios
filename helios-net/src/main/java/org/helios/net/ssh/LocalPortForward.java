...
public class LocalPortForward implements LocalAcceptThreadStateListener {
	...
	/**
	 * Creates a new wrapped local port forward
	 * @param portForwarder The wrapped port forwarder
	 * @param remoteHost The remote host being port forwarded to 
	 * @param localPort The local listening port
	 * @param remotePort The remote forwarded port
	 */
	LocalPortForward(SSHService service, int localPort, int remotePort) {
		try {
			this.portForwarder = service.sshConnection.createLocalPortForwarder(localPort, service.host, remotePort, this);
...
//		}
	...
	public void restart() throws Exception {
		...
		synchronized(connected) {
			...
			portForwarder = service.sshConnection.createLocalPortForwarder(localPort, hostAddress, remotePort, this);
		}
	}
